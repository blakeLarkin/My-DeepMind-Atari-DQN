...
class ReplayMemory:
    ...
    def __init__(self, args):
        self.samples = []
        self.maxSamples = args.replayCapacity
        self.prioritizedReplay = args.prioritizedReplay
    ...
    def _updateWeightsForNewlyAddedSample(self):
        ...
        if self.samples[-1].isInteresting():
            ...
            uninterestingSampleRange = max(1, len(self.samples) / max(2, 2 * self.numInterestingSamples))
